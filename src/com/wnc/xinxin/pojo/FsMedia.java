...
public class FsMedia implements Serializable
{
	...
	{
		return "{id:\"" + id + "\", media_name:\"" + media_name + "\", media_fullpath:\"" + media_fullpath + "\", media_type:\"" + media_type + "\", sn:\"" + sn + "\", media_size:\"" + media_size + "\", create_time:\"" + create_time + "\", is_deleted:\"" + is_deleted + "\"}";
	}

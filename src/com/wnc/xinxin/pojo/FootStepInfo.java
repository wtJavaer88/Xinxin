...
public class FootStepInfo implements Serializable
{
	...
	{
		return "{id:\"" + id + "\", uuid:\"" + uuid + "\", fs_desc:\"" + fs_desc + "\", is_deleted:\"" + is_deleted + "\", tag_names:\"" + tag_names + "\", day:\"" + day + "\", create_time:\"" + create_time + "\", update_time:\"" + update_time + "\", update_by:\"" + update_by
